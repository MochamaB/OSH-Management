...
{
    /// <summary>
    /// ViewModel for Line Chart Widget using ApexCharts
    /// Shows data in line/area format for trends over time
    /// </summary>
    public class LineChartViewModel
    {
        // Basic Properties
        public string Title { get; set; } = string.Empty;
        public List<LineChartSeriesViewModel> Series { get; set; } = new List<LineChartSeriesViewModel>();
